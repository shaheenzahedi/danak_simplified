...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './version.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_VERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VERSION actions', async () => {
      const expectedActions = [
        {
