...
import reducer, {
  ...
  reset,
  updateEntity,
} from './tablet-user-watch-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETUSERWATCHLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLETUSERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLETUSERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLETUSERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLETUSERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLETUSERWATCHLIST actions', async () => {
      const expectedActions = [
        {
