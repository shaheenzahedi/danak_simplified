...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './donor.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IDonor, defaultValue } from 'app/shared/model/donor.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONOR actions', async () => {
      const expectedActions = [
        {
