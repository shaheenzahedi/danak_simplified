...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONORWATCHLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONORWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONORWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONORWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONORWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONORWATCHLIST actions', async () => {
      const expectedActions = [
        {
