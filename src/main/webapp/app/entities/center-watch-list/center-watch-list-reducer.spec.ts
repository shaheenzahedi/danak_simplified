...
import reducer, {
  ...
  reset,
  updateEntity,
} from './center-watch-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTERWATCHLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTERWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTERWATCHLIST actions', async () => {
      const expectedActions = [
        {
