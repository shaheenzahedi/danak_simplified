...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTERIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTERIMAGE actions', async () => {
      const expectedActions = [
        {
