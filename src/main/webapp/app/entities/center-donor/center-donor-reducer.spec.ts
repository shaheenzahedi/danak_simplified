...
import reducer, {
  ...
  reset,
  updateEntity,
} from './center-donor.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { defaultValue, ICenterDonor } from 'app/shared/model/center-donor.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTERDONOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTERDONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTERDONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTERDONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTERDONOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTERDONOR actions', async () => {
      const expectedActions = [
        {
