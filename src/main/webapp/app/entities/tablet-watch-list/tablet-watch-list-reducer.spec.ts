...
import reducer, {
  ...
  reset,
  updateEntity,
} from './tablet-watch-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETWATCHLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLETWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLETWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLETWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLETWATCHLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLETWATCHLIST actions', async () => {
      const expectedActions = [
        {
