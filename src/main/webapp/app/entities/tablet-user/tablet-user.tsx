...
export const TabletUser = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.tabletUser.totalItems);
  ...
  return (
    <div>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lastName')}>
                  <Translate contentKey="danakApp.tabletUser.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/tablet-user/${tabletUser.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/tablet-user/${tabletUser.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={tabletUserList && tabletUserList.length > 0 ? '' : 'd-none'}>
