...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLETUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLETUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLETUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLETUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLETUSER actions', async () => {
      const expectedActions = [
        {
