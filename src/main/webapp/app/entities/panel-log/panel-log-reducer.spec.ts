...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './panel-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PANELLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_PANELLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PANELLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PANELLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PANELLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PANELLOG actions', async () => {
      const expectedActions = [
        {
