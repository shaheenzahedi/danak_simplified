...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPLOADEDFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UPLOADEDFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UPLOADEDFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UPLOADEDFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UPLOADEDFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UPLOADEDFILE actions', async () => {
      const expectedActions = [
        {
