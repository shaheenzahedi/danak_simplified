...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONORIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONORIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONORIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONORIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONORIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONORIMAGE actions', async () => {
      const expectedActions = [
        {
