...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLETLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLETLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLETLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLETLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLETLOG actions', async () => {
      const expectedActions = [
        {
