...
import reducer, {
  ...
  reset,
  updateEntity,
} from './tablet-user-image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETUSERIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLETUSERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLETUSERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLETUSERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLETUSERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLETUSERIMAGE actions', async () => {
      const expectedActions = [
        {
