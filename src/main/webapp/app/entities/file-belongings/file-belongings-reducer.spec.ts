...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEBELONGINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILEBELONGINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILEBELONGINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILEBELONGINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILEBELONGINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILEBELONGINGS actions', async () => {
      const expectedActions = [
        {
