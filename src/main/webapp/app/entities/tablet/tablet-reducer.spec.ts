...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tablet.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ITablet, defaultValue } from 'app/shared/model/tablet.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLET actions', async () => {
      const expectedActions = [
        {
