...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESHARE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILESHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESHARE actions', async () => {
      const expectedActions = [
        {
